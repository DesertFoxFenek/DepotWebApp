...
export const initialState = {"state": {"is_hydrated": false, "router": {"session": {"client_token": "", "client_ip": "", "session_id": ""}, "headers": {"host": "", "origin": "", "upgrade": "", "connection": "", "pragma": "", "cache_control": "", "user_agent": "", "sec_websocket_version": "", "sec_websocket_key": "", "sec_websocket_extensions": "", "accept_encoding": "", "accept_language": ""}, "page": {"host": "", "path": "", "raw_path": "", "full_path": "", "full_raw_path": "", "params": {}}}}, "state.select_state": {"depot": [], "option": "Wybierz pozycje", "options": ["Rozwiń mnie", "Zajezdnia Borek", "Zajezdnia Olbin", "Zajezdnia Gaj", "Zajezdnia Obornicka"], "vehicle_timetable": []}, "state.alert_dialog_state": {"show": false}, "state.login_state": {"depots": [], "login": "", "output": "", "password": ""}, "state.manager_data": {"free_vehicles": [], "vehicle_timetable": []}, "state.sidebar_state": {"brigades_num": "", "depot_adress": "", "depot_name": "", "vehicles_num": ""}, "state.data_table_state": {"columns": ["Numer", "Nazwa", "Model", "Linia", "Brygada", "Przystanek Startowy", "Przystanek Końcowy", "Czas przejazdu", "Wyjazd"], "data": []}}
