...
export const initialState = {"state": {"is_hydrated": false, "router": {"session": {"client_token": "", "client_ip": "", "session_id": ""}, "headers": {"host": "", "origin": "", "upgrade": "", "connection": "", "pragma": "", "cache_control": "", "user_agent": "", "sec_websocket_version": "", "sec_websocket_key": "", "sec_websocket_extensions": "", "accept_encoding": "", "accept_language": ""}, "page": {"host": "", "path": "", "raw_path": "", "full_path": "", "full_raw_path": "", "params": {}}}}, "state.select_state": {"depot": [], "option": "Wybierz pozycje", "options": ["Zajezdnia Borek", "Zajezdnia Olbin", "Zajezdnia Gaj", "Zajezdnia Obornicka"]}, "state.manager_data": {"free_vehicles": [], "vehicle_timetable": []}, "state.input_state_login": {"text_login": "Login", "text_password": "Hasło"}, "state.login_state": {"depots": [], "login": "", "output": "", "password": ""}}
