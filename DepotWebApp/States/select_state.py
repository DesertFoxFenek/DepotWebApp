...
class SelectState(rx.State):
    ...
    options: List[str] = ["Rozwiń mnie","Zajezdnia Borek", "Zajezdnia Olbin", "Zajezdnia Gaj", "Zajezdnia Obornicka"]
    depot: list
    ...
    def go_to_mng(self,option):
        ...
        if option == 'Wybierz pozycje': rx.window_alert("Nie wybrano pozycji")
        else:
            DP = DataParser()
